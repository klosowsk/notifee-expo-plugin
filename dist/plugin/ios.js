...
const addNotificationServiceFilesToProject = (c, props) => {
    const serviceExtensionFilesFolderPath = path.join(path.resolve("node_modules/" + config_1.PACKAGE_NAME + "/package.json"), "../dist/notificationExtensionsFiles/");
...
const addBackgroundModes = (c, props) => {
    return (0, config_plugins_1.withInfoPlist)(c, (nc) => {
        ...
        if (!Array.isArray(props.backgroundModes))
            (0, utils_1.throwError)("Background modes needs to be an array!");
        ...
        (0, utils_1.log)("Added background modes (" + config_1.BACKGROUND_MODES_TO_ENABLE.join(", ") + ")");
        return nc;
    });
};
/**
